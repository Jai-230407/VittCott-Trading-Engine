...
std::unordered\_map<int, OrderLocation> orderLocations;
...
\* `std::unordered\_map` stores order locations for efficient cancellation using stored iterators.
...
C:\\msys64\\ucrt64\\bin\\g++.exe -O2 -std=c++17 replay\_main.cpp OrderBook.cpp MatchingEngine.cpp TradeLogger.cpp Logger.cpp RiskManager.cpp -o replay.exe -pthread
...
C:\\msys64\\ucrt64\\bin\\g++.exe -O3 -DNDEBUG -std=c++17 benchmark\_main.cpp OrderBook.cpp MatchingEngine.cpp TradeLogger.cpp Logger.cpp RiskManager.cpp -o benchmark.exe -pthread
